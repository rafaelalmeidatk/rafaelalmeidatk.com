...
export const meta = {
  ...
  description: 'dkosadsamm da ji mid jaidjsaida s',
  date: '2020-05-13',
};
...
Which is not useful at all, look at this stack trace! We have no clue where the request was done, how can we fix this? We have some issues like [axios/axios#2387](https://github.com/axios/axios/issues/2387) and axios/axios#2069 but they don't have any solutions, so we need to solve this ourselves.
...
Since it is _just a string_, we can **store it** before doing the request, and assign it to the error before throwing it:
